...
import type { Servicio, Usuario, EventoCalendario } from '@/types';
import {
...
export const CalendarioTecnicos = () => {
  ...
  const openCreateModal = (tecnicoId?: string, dia?: Date) => {
    setForm({
      tecnicoId: tecnicoId || (tecnicos.length > 0 ? tecnicos[0].id : ''),
      titulo: '',
      descripcion: '',
      fecha: dia ? format(dia, 'yyyy-MM-dd') : format(new Date(), 'yyyy-MM-dd'),
      hora_inicio: '08:00',
      hora_fin: '09:00',
      tipo: 'personal',
      todo_el_dia: false,
  ...
  return (
    <div className="space-y-4">
                            ...
                            >
                              {isSunday ? (
                                ...
                                <div className="text-center py-5">
                                  ...
                                  <button
                                    onClick={() => openCreateModal(tec.id, day)}
      ...
      {/* Modal crear evento/bloqueo */}
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={() => setShowModal(false)} />
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl animate-in fade-in zoom-in-95 duration-200 max-h-[85vh] overflow-y-auto">
            <div className="p-5 border-b border-slate-100">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-bold text-slate-800">Bloquear horario</h3>
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full h-11 px-4 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white"
                >
                  {tecnicos.map(t => (
